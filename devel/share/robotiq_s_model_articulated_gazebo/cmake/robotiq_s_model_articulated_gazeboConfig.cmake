...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_s_model_articulated_gazebo_SOURCE_PREFIX /home/bdml/catkin_ws/src/robotiq/robotiq_s_model_articulated_gazebo)
  set(robotiq_s_model_articulated_gazebo_DEVEL_PREFIX /home/bdml/catkin_ws/devel)
  ...
  set(robotiq_s_model_articulated_gazebo_INSTALL_PREFIX /home/bdml/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robotiq_s_model_articulated_gazebo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robotiq_s_model_articulated_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bdml/catkin_ws/src/robotiq/robotiq_s_model_articulated_gazebo/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robotiq_s_model_articulated_gazebo_dep}_FOUND)
      find_package(${robotiq_s_model_articulated_gazebo_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robotiq_s_model_articulated_gazebo_dep} REQUIRED ${depend_list})
  endif()
