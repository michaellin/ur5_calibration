...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bdml/catkin_ws/src/robotiq/robotiq_modbus_rtu/${idir}'.  Ask the maintainer 'Shaun Edwards <sedwards@swri.org>, Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
    endif()
