...
(cl:defmethod master_safety_state-val ((m <IOStates>))
...
(cl:defmethod master_onoff_state-val ((m <IOStates>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<IOStates>)))
  ...
  "1d2308428cc386d8ec791a7ab792c8fd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'IOStates)))
  "Returns md5sum for a message object of type 'IOStates"
  "1d2308428cc386d8ec791a7ab792c8fd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IOStates>)))
  ...
  (cl:format cl:nil "Digital[] digital_in_states~%Digital[] digital_out_states~%Digital[] flag_states~%Analog[] analog_in_states~%Analog[] analog_out_states~%uint8 master_safety_state~%uint8 master_onoff_state~%~%================================================================================~%MSG: ur_msgs/Digital~%uint8 pin~%bool state~%~%================================================================================~%MSG: ur_msgs/Analog~%uint8 pin~%float32 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IOStates)))
  "Returns full string definition for message of type 'IOStates"
  (cl:format cl:nil "Digital[] digital_in_states~%Digital[] digital_out_states~%Digital[] flag_states~%Analog[] analog_in_states~%Analog[] analog_out_states~%uint8 master_safety_state~%uint8 master_onoff_state~%~%================================================================================~%MSG: ur_msgs/Digital~%uint8 pin~%bool state~%~%================================================================================~%MSG: ur_msgs/Analog~%uint8 pin~%float32 state~%~%~%"))
