...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4B.pack(_x.pos, _x.force, _x.speed, _x.position_compensation))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pos, _x.force, _x.speed, _x.position_compensation,) = _struct_4B.unpack(str[start:end])
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2B.pack(_x.success, _x.has_object))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.has_object,) = _struct_2B.unpack(str[start:end])
