...
class IOStates(genpy.Message):
  _md5sum = "1d2308428cc386d8ec791a7ab792c8fd"
...
"""
  __slots__ = ['digital_in_states','digital_out_states','flag_states','analog_in_states','analog_out_states','master_safety_state','master_onoff_state']
  _slot_types = ['ur_msgs/Digital[]','ur_msgs/Digital[]','ur_msgs/Digital[]','ur_msgs/Analog[]','ur_msgs/Analog[]','uint8','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       digital_in_states,digital_out_states,flag_states,analog_in_states,analog_out_states,master_safety_state,master_onoff_state
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.analog_out_states:
        ...
        buff.write(_struct_Bf.pack(_x.pin, _x.state))
      _x = self
      buff.write(_struct_2B.pack(_x.master_safety_state, _x.master_onoff_state))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.master_safety_state, _x.master_onoff_state,) = _struct_2B.unpack(str[start:end])
      return self
